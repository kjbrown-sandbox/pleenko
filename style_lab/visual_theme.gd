...
@export var bucket_fade_duration := 0.5                           # still used by drum-tier expiration path
@export var linger_fade_duration := 2.5                           # DEPRECATED — lingering drone fade removed
@export var eviction_fade_duration := 0.4                         # DEPRECATED — voice cap eviction removed
