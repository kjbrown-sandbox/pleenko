...
func _apply_theme() -> void:
	...
	# Main-menu buttons use `normal_text_color` (the palette's darkest, also
	# PLUNK's OLD color) as the bar/border — the title and buttons swapped to
	# give the wordmark a softer presence. MenuTitle does the matching swap.
